...
- @openpkg-ts/sdk + @openpkg-ts/spec move together, currently ^0.55.2 / ^0.55.0 (sdk 0.55.2 depends on spec ^0.55.0); both track latest minor (0.x caret = locked minor, so upstream releases require an explicit bump + drift release).
