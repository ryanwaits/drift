...
- @openpkg-ts/sdk + @openpkg-ts/spec move together, currently ^0.54.8 / ^0.54.8; both track latest minor (0.x caret = locked minor, so upstream releases require an explicit bump + drift release).
