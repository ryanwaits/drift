...
- @openpkg-ts/sdk + @openpkg-ts/spec move together, currently ^0.54.10 / ^0.54.9 (sdk 0.54.10 depends on spec ^0.54.9); both track latest minor (0.x caret = locked minor, so upstream releases require an explicit bump + drift release).
