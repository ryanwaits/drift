...
- @openpkg-ts/sdk + @openpkg-ts/spec move together, currently ^0.54.5 / ^0.54.4 (sdk 0.54.5 depends on spec ^0.54.4); both track latest minor (0.x caret = locked minor, so upstream releases require an explicit bump + drift release).
